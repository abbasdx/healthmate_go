  ...
  return (
    <header className="border-b bg-white/95 backdrop-blur-sm fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        {/* RIGHT SIDE → Authentication/Dashboard Controls */}
        {isAuthenticated && showDashboardNav ? (
                ...
                <DropdownMenuLabel>
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p 
                        className="text-sm text-gray-500 truncate max-w-[140px]"
            ...
            {!isAuthenticated ? (
              <>
                ...
                <Link href="/signup/patient" className="hidden md:block">
                  <Button className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-full px-6">
                    Book Consultation
                  </Button>
                </Link>
              </>
