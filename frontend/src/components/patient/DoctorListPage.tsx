...
import { cities, healthcareCategories, healthcareCategoriesList, specializations } from '@/lib/constant';
...
const DoctorListPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-16">
      ...
      {/* Doctor Cards - ✅ Updated with responsive grid layout */}
              ...
              <Card key={doctor._id} className="hover:shadow-xl transition-all duration-300 bg-white border-0 shadow-md h-full">
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <div className="text-center mb-4">
                    ...
                    <h3 className="text-lg font-bold text-blue-700 mb-1">{doctor.name}</h3>
                  ...
                  <div className="space-y-2 mb-4 text-center">
                    <div className="flex items-center justify-center text-gray-600">
                      ...
                      <span className="text-sm">{doctor.hospitalInfo?.city || 'Mumbai'}</span>
                    </div>
                    <div className=" flex justify-center items-center gap-2 text-center">
                      <p className="text-gray-600 text-md font-semibold">Consultation Fee:</p>
                  ...
                  <div className="mt-auto">
                    <Link href={`/patient/booking/${doctor._id}`} className="block">
                      <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-lg py-2 text-sm font-medium shadow-lg hover:shadow-xl transition-all">
                        Book Appointment
                      </Button>
                    </Link>
                  </div>
